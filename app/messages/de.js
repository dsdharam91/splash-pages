export default {
  ...
  security: {
    title: 'Sicherheit',
    nav_title: 'Sicherheit',
    description: 'GoCardless ist vom ersten bis zum letzten Stein sicher gebaut und benutzt Verschlüsselung auf dem gleichen Level wie das Militär, um Ihre Daten stets sicher zu halten. Wir sind autorisiert von der Financial Conduct Authority.',
    header1: 'Von Anfang an sicher gebaut',
    header2: 'GoCardless nutzt Verschlüsselung, die dem Level des Militärs entspricht, um Ihre Daten stets sicher zu bewahren. Wir sind autorisiert von den wichtigsten Namen in der Zahlungsbranche.',
