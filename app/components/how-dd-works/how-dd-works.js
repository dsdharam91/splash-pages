      ...
      next={(
        ...
        <div className='modal__container--slide modal__container--slide--1'>
          ...
          <div className='modal__container__copy u-padding-Al'>
            <h2 className='u-text-heading u-color-dark-gray u-text-l u-text-light u-padding-Txl u-margin-Tl'>
              Why Direct Debit?
            </h2>
            <p className='u-text-xs u-color-dark-gray u-padding-Tm'>
        ...
        <div className='modal__container--slide modal__container--slide--3'>
          ...
          <div className='modal__container__copy u-padding-Al'>
            ...
            <hr />
            <h5 className='u-text-label u-text-upcase u-text-xxs u-text-semi u-color-dark-gray u-margin-Bxs'>Worth reading</h5>
