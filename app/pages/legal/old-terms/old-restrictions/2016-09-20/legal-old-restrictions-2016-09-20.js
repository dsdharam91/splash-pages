...
export default class LegalOldRestrictions20160920 extends React.Component {
  displayName = 'LegalOldRestrictions20160920'

  render() {
    return (
      <LegalPage>
        <h2 className='u-text-heading-light u-text-m u-color-dark-gray'>Restricted activities [prior to 23rd September 2016]</h2>
