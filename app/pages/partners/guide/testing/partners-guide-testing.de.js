  ...
  render() {
    return (
      <Translation locales='de'>
        ...
        <p>
          Ja - <a href='https://manage-sandbox.gocardless.com/signup' target='_blank'>Hier</a> können Sie Ihren
          Sandbox-Account sofort einrichten.
        </p>
        ...
        <p>
          Schreiben Sie uns Ihr Anliegen per E-Mail an <Href to='email' itemProp='email' />. Bei technischen Fragen helfen Ihnen
          unsere Entwickler montags bis freitags von 10-19 Uhr gerne weiter.
        </p>

        <h3>Wie stelle ich von der Test-Version auf den Echtbetrieb um?</h3>

        <p>
          Sobald Sie Ihre Integration in unserer Sandbox-Umgebung getestet haben, schreiben Sie uns
