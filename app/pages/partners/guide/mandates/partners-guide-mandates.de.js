...
export default class PartnersGuideMandatesDe extends React.Component {
  ...
  render() {
    return (
        ...
        <p>
          Ja - Die Übertragung von Lastschriftmandaten ist völlig unkompliziert. Das Handbuch zur Übertragung von SEPA-Mandaten finden
          Sie <a href='https://gocardless.com/de/handbuch/sepa/mandat-uebertragung/' target='_blank'>hier</a>.
          Um Lastschriftmandate aus dem Vereinigten Königreich zu übertragen, lesen Sie unser Handbuch auf Englisch
          dazu <a href='https://gocardless.com/direct-debit/transferring/' target='_blank'>hier</a>.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Der Prozess dauert etwa 1 Woche.</strong> Bis der komplette Prozess abgeschlossen ist, dauert es ca. eine Woche
            für die Übertragung von SEPA-Mandaten und ca. 4 Wochen für Mandate aus Großbritannien.
          </li>

          <li>
            <strong>Dazu benötigen Sie die Daten Ihrer Kunden.</strong> Die Übertragung erfordert die Adresse, E-Mail, den Namen und
            die Bankdaten Ihrer Kunden. Wenn Sie diese nicht zur Hand haben, sollte Ihr aktueller Anbieter Ihnen die Angaben übermitteln
            können.
          </li>
        </ul>
