            ...
            <div className='grid u-center u-text-center'>
              <div className='grid__cell u-size-1of3 u-padding-Hn u-text-center'>
                ...
                <p className='u-size-4of5 u-center u-color-dark-gray u-margin-Txs'>
                  Make it easier for your prospects to become and remain a customer of your business.
                </p>
              </div>
              <div className='grid__cell u-size-1of3 u-padding-Hn u-text-center'>
                <figure className='svg-icon u-center'>
                ...
                <p className='u-size-4of5 u-center u-color-dark-gray u-margin-Txs'>
                  Keep focus on your core business with automated payment collections.
                </p>
              </div>
              <div className='grid__cell u-size-1of3 u-padding-Hn u-text-center'>
                <figure className='svg-icon u-center'>
                ...
                <p className='u-size-4of5 u-center u-color-dark-gray u-margin-Txs'>
                  GoCardless connects to your billing, accounting and CRM software.
                </p>
              </div>
            </div>
          </div>
