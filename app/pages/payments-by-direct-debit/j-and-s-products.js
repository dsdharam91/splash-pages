...
export default class LandingPageJAndSProducts extends React.Component {
  displayName = 'LandingPageJAndSProducts'
        ...
        <div className='page-hero u-padding-Bxxl'>
          <div className='site-container u-padding-Vxxl u-text-center'>
            ...
            <p className='u-text-heading-light u-text-m u-color-invert u-padding-Ts'>
              A simpler and smarter way for J&amp;S distributors to collect repayments.
            </p>
          </div>
        </div>
