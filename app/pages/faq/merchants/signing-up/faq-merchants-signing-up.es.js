      ...
      <Translation locales='es'>
        ...
        <Translation locales={['es']}>
          ...
          <p className='para'>
            ...
            Para crear una cuenta en producción y empezar a cobrar a tus clientes, necesitas ir
            <a href="https://manage.gocardless.com/signup?lang=es"> aquí</a>.
          </p>
          <h3 className='section-heading u-text-heading-light u-color-dark-gray u-margin-Vm u-text-s'>
          ...
          <p className='para'>
            Después de registrarte online, recomendamos que hagas un cobro de prueba a tí mismo. No te
          ...
          <p className='para'>
            ...
            Sociedades limitas y para individuos. Si no eres ninguna de esto, contacta con
            <Link to='contact_sales' className='btn btn--invert btn--move'> nuestro equipo de ventas.</Link>
          </p>
          <p className='para'>
