  ...
  render() {
    return (
      <JobsPage>
        ...
        <p className='para'>
          As a Developer Support Engineer, you will delve into the product on a technical level
          and assist developers using GoCardless. You'll guide integrators through the capabilities
          of our service, and help them to get the most out of our API. You'll also help the Operations
          team internally by being an expert in the inner workings of our product, handling data requests,
          configuring accounts, and providing guidance on complex support and risk prevention cases.
        </p>
