    ...
    return (
      <JobsPage>
        ...
        <p className='para'>
          ...
          Our <a href='https://gocardless.com/blog/a-new-payment-network-for-the-internet/'>vision </a> is to
        ...
        <ul className='list u-margin-Tm'>
          ...
          <li>
            Strong analytical skills and the ability to use a wide range of resources to come to
        ...
        <ul className='list u-margin-Tm'>
          ...
          <li>
            Stocked kitchen and unlimited coffee!
          </li>
        </ul>
        <p className='para'>
        If you’re unsure, please apply - we’d love to hear from you!
        </p>
        <a href='http://boards.greenhouse.io/gocardless/jobs/162976' className='btn u-margin-Vs'>
          Apply now
        </a>
      </JobsPage>
    );
