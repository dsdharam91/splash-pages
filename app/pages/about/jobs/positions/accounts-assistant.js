  ...
  render() {
    return (
      <JobsPage>
        ...
        <p className='para'>
          Join our Finance team and help us continue to support GoCardless' amazing growth.
        </p>
        <p className='para'>
        ...
        <ul className='list'>
          ...
          <li>
            Providing quarterly financials to our VCs.
          </li>
          <li>
          ...
          <li>
            Give ad hoc support to the Finance team, including assistance with the R&D tax return and performing the VAT return.
          </li>
        </ul>
        ...
        <ul className='list u-margin-Tm'>
          <li>
            You have at least 2 years of experience as a bookkeeper preferably working with SMEs or startups.
          </li>
          <li>
