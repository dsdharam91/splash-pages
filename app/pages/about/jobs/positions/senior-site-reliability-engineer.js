...
export default class SeniorSiteReliabilityEngineer extends React.Component {
  displayName = 'SeniorSiteReliabilityEngineer'

  render() {
    return (
      <JobsPage>
        <h3 className='u-text-heading-light u-text-m u-color-dark-gray'>Senior Site Reliability Engineer</h3>
        <p className='para'>
