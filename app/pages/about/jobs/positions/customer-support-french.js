...
export default class CustomerSupportFrench extends React.Component {
  displayName = 'CustomerSupportFrench'
      ...
      <JobsPage>
        <Translation locales='fr'>
          ...
          <ul className='list u-margin-Tm'>
            ...
            <li>
              Utiliser notre solution interne sophistiquée de détection de fraude
              pour protéger nos utilisateurs.
            </li>
            <li>
            ...
            <li>
              Travailler avec notre équipe produit pour prioritiser les demandes
              de fonctionnalités.
            </li>
          </ul>
          <p className='para'>
          ...
          <a href='https://boards.greenhouse.io/gocardless/jobs/159393' className='btn u-margin-Vs'>
            Postulez
          </a>
        </Translation>
        ...
        <Translation locales='en'>
          ...
          <p className='para'>
            ...
            makes it simple for small and medium businesses to take recurring
            payments, and allows startups and large corporations to automate
            their payments in a way that was never possible before.
          </p>
          <p className='para'>
            After launching in the UK and entering the French market in early
            2015 - as covered by <a href='http://www.lefigaro.fr/societes/2015/04/12/20005-20150412ARTFIG00171-gocardless-pret-a-bousculer-les-banques-francaises.php' target='_blank'>
            Le Figaro</a> and <a href='http://www.lesechos.fr/13/04/2015/lesechos.fr/0213743712_le-prelevement-bancaire-seduit-de-nouveaux-acteurs.htm' target='_blank'>
            Les Echos</a> - we are rapidly gaining traction in France, serving
            hundreds of companies such as Habitat, Mangopay and Zenchef.
          </p>
          <p className='para'>
          ...
          <p className='para'>
            ...
            and the level of information you give depending on what the
            individual user needs to know. You’ll be empowered to actually
            address their concerns and be responsible for following through
            until they are satisfied. You will join our friendly, tight-knit
            team and work together to find creative solutions to even the
            toughest problems. Ultimately we want every customer to hang up
            happy.
          </p>
          <p className='para'>
          ...
          <p className='para'>
            We care deeply about our customers’ experience and act with their
            best interest at heart: we take responsibility for their problems
          ...
          <ul className='list u-margin-Tm'>
            ...
            <li>
              You’re a quick learner, able to digest complex information and
              distill it into clear answers.
            </li>
            <li>
            ...
            <li>
              You are a native-level French speaker and have a flawless command
