...
export default class ProductMarketingExecuitve extends React.Component {
  displayName = 'ProductMarketingExecuitve'

  render() {
    return (
      <JobsPage>
        <h3 className='u-text-heading-light u-text-m u-color-heading'>Product Marketing Executive</h3>
        <p className='para'>
          Drive our growth and shape our future.
        </p>
        <p className='para'>
          At GoCardless we’re looking to scale from processing £1 billion a year
          to over £10 billion. Our vision is to create a global connected payments network,
          making payments simpler on the internet no matter what country you're
          in or what software you are using.
        </p>
        <p className='para'>
          As we expand both domestically and globally, our go-to-market strategy
          becomes ever more critical, ensuring we’re crafting the right messages
        ...
        <p className='para'>
          Collaborating with the wider Marketing and Product teams you’ll be part
          of the team responsible for the launch of new products and features, both
          internally and externally using the most appropriate go-to-market channels.
        </p>
        ...
        <ul className='list u-margin-Tm'>
          ...
          <li>
            ...
            to convert complex concepts into clear, engaging copy for internal and external audiences.
          </li>
          <li>
