  ...
  render() {
    return (
      <JobsPage>
        ...
        <p className='para'>
          GoCardless is looking for a Site Reliability Engineer to help scale our infrastructure
        ...
        <p className='para'>
          As a Site Reliability Engineer at GoCardless you will be part of a small team that sets the
        ...
        with every other team within engineering &ndash; from product to data &ndash; to drive engineering efforts in the company.
        </p>
        ...
        <ul className='list'>
          ...
          <li>Fluency in one or more programming languages, and you write clean and effective code.</li>
        </ul>
        <p className='para'>
          This role would ideally suit someone with some previous
          experience in a similar role, or as a Software Engineer but keen to transition into a Site Reliability Engineer role.
