...
export default class CustomerSuccessManagerFrance extends React.Component {
  displayName = 'CustomerSuccessManagerFrance'

  render() {
    return (
      <JobsPage>
        <h3 className='u-text-heading-light u-text-m u-color-heading'>Customer Success Manager: France </h3>
        <p className='para'>
        ...
        <p className='para'>
          After launching in the UK and entering the French market in early 2015
          - as covered by Le Figaro and Les Echos - we are rapidly gaining traction
          in France, serving hundreds of companies such as Habitat, Mangopay and
          Zenchef.
        </p>
        <p className='para'>
        ...
        <p className='para'>
          As a Customer Success Manager, you will be responsible for the long
          term success of our larger customers with GoCardless.
        </p>
        ...
        <ul className='list'>
          ...
          <li>
            Work closely with the the Customer Success team in the UK to refine and improve processes.
          </li>
          <li>
          ...
          <li>
            Support the Marketing team by delighting customers, leading to
        ...
        <ul className='list u-margin-Tm'>
          ...
          <li>
            You are a native-level French speaker and have a flawless command of both French and English.
          </li>
        </ul>
        <p className='para'>
          This role will be based in Paris (with training in and some travel to
          our UK offices) and would particularly suit people with previous Customer
          Success or Account Management experience. However our team come from
          a variety of backgrounds and we welcome diversity – if you’re unsure,
          please apply.
        </p>
        <p className='para'>
          In your application, please include your CV and a cover letter
          (in English) explaining why you are a great candidate for this position.
        </p>
        <a href='http://boards.greenhouse.io/gocardless/jobs/544486' className='btn u-margin-Vs'>
          Apply now
        </a>
      </JobsPage>
    );
