...
export default class StoriesZenchef extends React.Component {
  ...
  render() {
    return (
      <StoryPage
        title='Zenchef'
        tagline='Zenchef a augmenté son chiffre d’affaire de 90.000 € en automatisant le prélèvement via GoCardless'
        tips={[
        ...
        <StoryQuote tag='Le secteur des paiements est dominé par des logiciels complexes et archaïques'>
          <p className='para u-margin-Tn'>
            <a href='http://www.zenchef.com' className='u-link-color-p u-text-underline' target='_blank'>
            Zenchef</a>, un outil tout-en-un pour gérer la communication de restaurants (ex-1001 Menus),
          ...
          <p className='para'>
            Avant GoCardless, Zenchef gérait leur prélèvement par l'intermédiaire d'un autre prestataire
        ...
        <StoryBigQuote person='Julien Balmont' position='Zenchef'>
        ...
        <StoryQuote tag="Nous voulions pouvoir faciliter l'expérience du client et notre gestion">
          <p className='para u-margin-Tn'>Zenchef s'est rendu compte que le processus actuel n'était
        ...
        <StoryQuote tag="Passer à GoCardless nous a permis de gagner du temps et de l'argent">
          <p className='para u-margin-Tn'>
            Zenchef peut désormais gérer tous les mandats dans Zuora et déclencher les prélèvements
            lorsque les factures viennent à échéance automatiquement. Mieux, le statut des paiements
            avec motifs est automatiquement fourni dans Zuora, ce qui permet à Zenchef de relancer un client ou
